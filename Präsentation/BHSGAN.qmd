...
Consider $f:[0,\infty)\to\bR$, continuous, concave on some interval $[0,a),\, a>0$, and convex on $[a,\infty)$.
...
Consider the function which is convcave on $[0,\exp(-1)]$ and convex on $(\exp(-1),\infty)$
